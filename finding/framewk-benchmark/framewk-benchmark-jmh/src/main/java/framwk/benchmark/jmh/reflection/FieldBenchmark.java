...
public class FieldBenchmark {
    ...
    private Field        reflectiveAccessible;
    private Field        reflectivePrimitive;
    private Field        reflectiveAccessiblePrimitive;
    private Field        reflectiveAccessiblePrivate;
    ...
    private static final MethodHandle METHOD_HANDLE_UNREFLECTED_PRIMITIVE;
    private static final MethodHandle METHOD_HANDLE_UNREFLECTED_PRIVATE;
